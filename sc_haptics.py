...
class SteamControllerHaptics:
    ...
    def sweep(self, intensity=1.0):
        # 15000 to 25000 microseconds (15-25ms)
        dur = int(15000 + 10000 * intensity)
        self.pulse(STEAM_PAD_RIGHT, dur, 0, 1, 0)
        
    def takeout(self, mass=1.0):
        # 30000 to 65000 microseconds (30-65ms)
        dur = int(30000 + 35000 * mass)
        dur = max(20000, min(dur, 65000))
        self.pulse(STEAM_PAD_BOTH, dur, 0, 1, 0)
