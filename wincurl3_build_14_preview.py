...
class Stone:
    ...
    def _render_base(self, color):
        ...
        # BUILD 14: Layered Pseudo-3D Geometry
        pygame.draw.circle(s, (100, 105, 110), (self.radius+2, self.radius+2), self.radius)
        pygame.draw.circle(s, (130, 135, 140), (self.radius+2, self.radius+2), self.radius - 3)
        pygame.draw.circle(s, color, (self.radius+2, self.radius+2), 22)
        pygame.draw.circle(s, lerp_color(color, WHITE, 0.3), (self.radius+2, self.radius+2), 19)
        pygame.draw.circle(s, (90, 95, 100), (self.radius+2, self.radius+2), 12)
...
class WinCurl3:
    ...
    def fire_stone(self):
        ...
        # BUILD 14: Center-Line Dead-zone
        if abs(pull.x) < 3.5: 
            pull.x = 0
    ...
    def handle_menu_events(self, event):
        ...
        if event.type == MOUSEBUTTONDOWN and event.button == 1:
            ...
            # BUILD 14: Misclick Debouncing (300ms)
