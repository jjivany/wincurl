...
class WinCurlAudioEngine:
    ...
    def _synthesize_heavy_bg(self):
        ...
        load_sound("snd_chal_comp", "challenge_complete.ogg", lambda return_bytes=False: self._synthesize_vosim_phrase("CHALLENGE_COMPLETE", 1.2, return_bytes=return_bytes))
        load_sound("snd_red_wins", "red_wins.ogg", lambda return_bytes=False: self._synthesize_vosim_phrase("RED_TEAM_WINS", 1.2, return_bytes=return_bytes))
        load_sound("snd_ylw_wins", "yellow_wins.ogg", lambda return_bytes=False: self._synthesize_vosim_phrase("YELLOW_TEAM_WINS", 1.2, return_bytes=return_bytes))
